...
type Service interface {
	Create(ctx context.Context, serviceID uint, name string, access access.Access) (p types.Permission, err error)
...
func (s service) Create(ctx context.Context, serviceID uint, name string, access access.Access) (p types.Permission, err error) {
	p = types.Permission{
		ServiceID: serviceID,
		Name:      name,
		Access:    access,
